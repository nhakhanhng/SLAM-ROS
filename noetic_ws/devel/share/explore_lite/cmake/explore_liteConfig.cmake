...
if("TRUE" STREQUAL "TRUE")
  set(explore_lite_SOURCE_PREFIX /SLAM/noetic_ws/src/m-explore/explore)
  set(explore_lite_DEVEL_PREFIX /SLAM/noetic_ws/devel)
  ...
  set(explore_lite_INSTALL_PREFIX /SLAM/noetic_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'explore_lite' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/SLAM/noetic_ws/src/m-explore/explore/${idir}'.  ${_report}")
    endif()
