...
#include "tutourial_intefaces/msg/detail/sphere__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tutourial_intefaces::msg::Sphere & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tutourial_intefaces::msg::Sphere & ros_message)
{
  // Member: center
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tutourial_intefaces::msg::Sphere;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tutourial_intefaces::msg::Sphere *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tutourial_intefaces::msg::Sphere *>(
    untyped_ros_message);
...
get_message_type_support_handle<tutourial_intefaces::msg::Sphere>()
{
  return &tutourial_intefaces::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tutourial_intefaces, msg, Sphere)() {
  return &tutourial_intefaces::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
