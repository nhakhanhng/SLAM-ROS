...
#include "tutourial_intefaces/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tutourial_intefaces::msg::Num;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tutourial_intefaces::msg::Num *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tutourial_intefaces::msg::Num *>(
    untyped_ros_message);
...
{
  return &tutourial_intefaces::msg::typesupport_fastrtps_cpp::_Num__handle;
}
