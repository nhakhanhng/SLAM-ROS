...
tutourial_intefaces__msg__Num__create()
{
  ...
  tutourial_intefaces__msg__Num * msg = (tutourial_intefaces__msg__Num *)allocator.allocate(sizeof(tutourial_intefaces__msg__Num), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(tutourial_intefaces__msg__Num));
  bool success = tutourial_intefaces__msg__Num__init(msg);
  if (!success) {
...
tutourial_intefaces__msg__Num__destroy(tutourial_intefaces__msg__Num * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    tutourial_intefaces__msg__Num__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
tutourial_intefaces__msg__Num__Sequence__init(tutourial_intefaces__msg__Num__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tutourial_intefaces__msg__Num * data = NULL;

  if (size) {
    data = (tutourial_intefaces__msg__Num *)allocator.zero_allocate(size, sizeof(tutourial_intefaces__msg__Num), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = tutourial_intefaces__msg__Num__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        tutourial_intefaces__msg__Num__fini(&data[i - 1]);
      }
...
tutourial_intefaces__msg__Num__Sequence__fini(tutourial_intefaces__msg__Num__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      tutourial_intefaces__msg__Num__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tutourial_intefaces__msg__Num__Sequence * array = (tutourial_intefaces__msg__Num__Sequence *)allocator.allocate(sizeof(tutourial_intefaces__msg__Num__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = tutourial_intefaces__msg__Num__Sequence__init(array, size);
  if (!success) {
...
tutourial_intefaces__msg__Num__Sequence__destroy(tutourial_intefaces__msg__Num__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    tutourial_intefaces__msg__Num__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
tutourial_intefaces__msg__Num__Sequence__are_equal(const tutourial_intefaces__msg__Num__Sequence * lhs, const tutourial_intefaces__msg__Num__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tutourial_intefaces__msg__Num__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tutourial_intefaces__msg__Num__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tutourial_intefaces__msg__Num);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    tutourial_intefaces__msg__Num * data =
      (tutourial_intefaces__msg__Num *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tutourial_intefaces__msg__Num__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tutourial_intefaces__msg__Num__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!tutourial_intefaces__msg__Num__copy(
